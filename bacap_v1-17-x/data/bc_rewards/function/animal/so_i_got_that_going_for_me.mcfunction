data modify storage bac_tracker:macro data set value {adv_bac_name:"so_i_got_that_going_for_me",adv_full_name:"blazeandcave:animal/so_i_got_that_going_for_me",adv_category:"animal",adv_extra_categories:[],adv_bac_type:"task",player_bac_team:"any",member_adv_rank:-1s}
