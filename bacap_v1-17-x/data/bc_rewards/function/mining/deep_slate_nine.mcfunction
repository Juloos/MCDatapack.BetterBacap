data modify storage bac_tracker:macro data set value {adv_bac_name:"deep_slate_nine",adv_full_name:"blazeandcave:mining/deep_slate_nine",adv_category:"mining",adv_extra_categories:[],adv_bac_type:"task",player_bac_team:"any",member_adv_rank:-1s}
