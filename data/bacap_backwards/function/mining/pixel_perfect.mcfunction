data modify storage bac_tracker:macro data set value {adv_bac_name:"pixel_perfect",adv_full_name:"blazeandcave:mining/pixel_perfect",adv_category:"mining",adv_extra_categories:["trophy"],adv_bac_type:"challenge",player_bac_team:"any",member_adv_rank:-1s}
