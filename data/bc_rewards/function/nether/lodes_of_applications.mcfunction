data modify storage bac_tracker:macro data set value {adv_bac_name:"lodes_of_applications",adv_full_name:"blazeandcave:nether/lodes_of_applications",adv_category:"nether",adv_extra_categories:[],adv_bac_type:"goal",player_bac_team:"any",member_adv_rank:-1s}
