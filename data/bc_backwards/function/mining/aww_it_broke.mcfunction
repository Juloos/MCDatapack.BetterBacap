data modify storage bac_tracker:macro data set value {adv_bac_name:"aww_it_broke",adv_full_name:"blazeandcave:mining/aww_it_broke",adv_category:"mining",adv_extra_categories:[],adv_bac_type:"task",player_bac_team:"any",member_adv_rank:-1s}
