data modify storage bac_tracker:macro data set value {adv_bac_name:"monsters_hunted",adv_full_name:"minecraft:adventure/kill_all_mobs",adv_category:"monsters",adv_extra_categories:["trophy"],adv_bac_type:"challenge",player_bac_team:"any",member_adv_rank:-1s}
