data modify storage bac_tracker:macro data set value {adv_bac_name:"no_banner_only_color",adv_full_name:"blazeandcave:building/no_banner_only_color",adv_category:"building",adv_extra_categories:[],adv_bac_type:"goal",player_bac_team:"any",member_adv_rank:-1s}
