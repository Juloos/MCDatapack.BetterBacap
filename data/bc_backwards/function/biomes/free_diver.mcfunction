data modify storage bac_tracker:macro data set value {adv_bac_name:"free_diver",adv_full_name:"blazeandcave:biomes/free_diver",adv_category:"biomes",adv_extra_categories:[],adv_bac_type:"goal",player_bac_team:"any",member_adv_rank:-1s}
