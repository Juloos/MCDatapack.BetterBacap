data modify storage bac_tracker:macro data set value {adv_bac_name:"olympic_athlete",adv_full_name:"blazeandcave:statistics/olympic_athlete",adv_category:"statistics",adv_extra_categories:[],adv_bac_type:"goal",player_bac_team:"any",member_adv_rank:-1s}
