data modify storage bac_tracker:macro data set value {adv_bac_name:"anti_gravity_generator",adv_full_name:"blazeandcave:end/anti_gravity_generator",adv_category:"end",adv_extra_categories:["trophy"],adv_bac_type:"challenge",player_bac_team:"any",member_adv_rank:-1s}
