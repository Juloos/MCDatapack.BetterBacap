data modify storage bac_tracker:macro data set value {adv_bac_name:"disen_berry_berry_bad",adv_full_name:"blazeandcave:farming/disen_berry_berry_bad",adv_category:"farming",adv_extra_categories:[],adv_bac_type:"task",player_bac_team:"any",member_adv_rank:-1s}
