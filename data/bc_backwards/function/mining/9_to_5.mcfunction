data modify storage bac_tracker:macro data set value {adv_bac_name:"9_to_5",adv_full_name:"blazeandcave:mining/9_to_5",adv_category:"mining",adv_extra_categories:[],adv_bac_type:"goal",player_bac_team:"any",member_adv_rank:-1s}
