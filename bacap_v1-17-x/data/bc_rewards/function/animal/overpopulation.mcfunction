data modify storage bac_tracker:macro data set value {adv_bac_name:"overpopulation",adv_full_name:"minecraft:husbandry/bred_all_animals",adv_category:"animal",adv_extra_categories:["trophy"],adv_bac_type:"challenge",player_bac_team:"any",member_adv_rank:-1s}
