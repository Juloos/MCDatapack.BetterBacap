data modify storage bac_tracker:macro data set value {adv_bac_name:"alpha_days",adv_full_name:"blazeandcave:biomes/alpha_days",adv_category:"biomes",adv_extra_categories:["terralith"],adv_bac_type:"challenge",player_bac_team:"any",member_adv_rank:-1s}
