data modify storage bac_tracker:macro data set value {adv_bac_name:"llama_festival",adv_full_name:"blazeandcave:animal/llama_festival",adv_category:"animal",adv_extra_categories:[],adv_bac_type:"goal",player_bac_team:"any",member_adv_rank:-1s}
