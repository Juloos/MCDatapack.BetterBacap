data modify storage bac_tracker:macro data set value {adv_bac_name:"crafters_crafting_crafters",adv_full_name:"minecraft:adventure/crafters_crafting_crafters",adv_category:"redstone",adv_extra_categories:[],adv_bac_type:"goal",player_bac_team:"any",member_adv_rank:-1s}
