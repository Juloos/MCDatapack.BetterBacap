data modify storage bac_tracker:macro data set value {adv_bac_name:"stealth_is_optional",adv_full_name:"blazeandcave:monsters/stealth_is_optional",adv_category:"monsters",adv_extra_categories:["trophy"],adv_bac_type:"goal",player_bac_team:"any",member_adv_rank:-1s}
