data modify storage bac_tracker:macro data set value {adv_bac_name:"top_of_the_world",adv_full_name:"blazeandcave:biomes/top_of_the_world",adv_category:"biomes",adv_extra_categories:[],adv_bac_type:"goal",player_bac_team:"any",member_adv_rank:-1s}
