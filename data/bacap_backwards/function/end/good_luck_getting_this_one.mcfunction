data modify storage bac_tracker:macro data set value {adv_bac_name:"good_luck_getting_this_one",adv_full_name:"blazeandcave:end/good_luck_getting_this_one",adv_category:"end",adv_extra_categories:["hidden","trophy"],adv_bac_type:"challenge",player_bac_team:"any",member_adv_rank:-1s}
