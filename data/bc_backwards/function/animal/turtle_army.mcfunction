data modify storage bac_tracker:macro data set value {adv_bac_name:"turtle_army",adv_full_name:"blazeandcave:animal/turtle_army",adv_category:"animal",adv_extra_categories:[],adv_bac_type:"goal",player_bac_team:"any",member_adv_rank:-1s}
