data modify storage bac_tracker:macro data set value {adv_bac_name:"sailor_of_the_seven_seas",adv_full_name:"blazeandcave:statistics/sailor_of_the_seven_seas",adv_category:"statistics",adv_extra_categories:["trophy"],adv_bac_type:"challenge",player_bac_team:"any",member_adv_rank:-1s}
