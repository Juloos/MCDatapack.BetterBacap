data modify storage bac_tracker:macro data set value {adv_bac_name:"unending_hell",adv_full_name:"blazeandcave:end/unending_hell",adv_category:"end",adv_extra_categories:["trophy"],adv_bac_type:"goal",player_bac_team:"any",member_adv_rank:-1s}
