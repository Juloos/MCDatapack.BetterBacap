data modify storage bac_tracker:macro data set value {adv_bac_name:"let_there_be_light",adv_full_name:"blazeandcave:building/let_there_be_light",adv_category:"building",adv_extra_categories:["trophy"],adv_bac_type:"challenge",player_bac_team:"any",member_adv_rank:-1s}
