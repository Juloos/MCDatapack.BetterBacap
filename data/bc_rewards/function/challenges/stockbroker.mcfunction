data modify storage bac_tracker:macro data set value {adv_bac_name:"stockbroker",adv_full_name:"blazeandcave:challenges/stockbroker",adv_category:"challenges",adv_extra_categories:["trophy"],adv_bac_type:"challenge",player_bac_team:"any",member_adv_rank:-1s}
