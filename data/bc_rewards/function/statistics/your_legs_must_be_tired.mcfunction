data modify storage bac_tracker:macro data set value {adv_bac_name:"your_legs_must_be_tired",adv_full_name:"blazeandcave:statistics/your_legs_must_be_tired",adv_category:"statistics",adv_extra_categories:["trophy"],adv_bac_type:"challenge",player_bac_team:"any",member_adv_rank:-1s}
