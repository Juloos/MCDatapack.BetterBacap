data modify storage bac_tracker:macro data set value {adv_bac_name:"heavy_metal",adv_full_name:"blazeandcave:enchanting/heavy_metal",adv_category:"enchanting",adv_extra_categories:[],adv_bac_type:"task",player_bac_team:"any",member_adv_rank:-1s}
