data modify storage bac_tracker:macro data set value {adv_bac_name:"total_beelocation",adv_full_name:"minecraft:husbandry/silk_touch_nest",adv_category:"animal",adv_extra_categories:[],adv_bac_type:"goal",player_bac_team:"any",member_adv_rank:-1s}
