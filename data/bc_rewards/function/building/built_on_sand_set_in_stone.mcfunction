data modify storage bac_tracker:macro data set value {adv_bac_name:"built_on_sand_set_in_stone",adv_full_name:"blazeandcave:building/built_on_sand_set_in_stone",adv_category:"building",adv_extra_categories:[],adv_bac_type:"goal",player_bac_team:"any",member_adv_rank:-1s}
