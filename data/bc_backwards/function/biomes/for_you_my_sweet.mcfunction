data modify storage bac_tracker:macro data set value {adv_bac_name:"for_you_my_sweet",adv_full_name:"blazeandcave:biomes/for_you_my_sweet",adv_category:"biomes",adv_extra_categories:["trophy"],adv_bac_type:"task",player_bac_team:"any",member_adv_rank:-1s}
