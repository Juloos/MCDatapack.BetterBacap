data modify storage bac_tracker:macro data set value {adv_bac_name:"event_horizon",adv_full_name:"blazeandcave:end/event_horizon",adv_category:"end",adv_extra_categories:["trophy"],adv_bac_type:"challenge",player_bac_team:"any",member_adv_rank:-1s}
