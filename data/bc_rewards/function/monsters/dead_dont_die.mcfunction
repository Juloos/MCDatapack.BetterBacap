data modify storage bac_tracker:macro data set value {adv_bac_name:"dead_dont_die",adv_full_name:"blazeandcave:monsters/dead_dont_die",adv_category:"monsters",adv_extra_categories:[],adv_bac_type:"task",player_bac_team:"any",member_adv_rank:-1s}
