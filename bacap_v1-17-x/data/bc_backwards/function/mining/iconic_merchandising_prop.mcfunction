data modify storage bac_tracker:macro data set value {adv_bac_name:"iconic_merchandising_prop",adv_full_name:"blazeandcave:mining/iconic_merchandising_prop",adv_category:"mining",adv_extra_categories:[],adv_bac_type:"task",player_bac_team:"any",member_adv_rank:-1s}
