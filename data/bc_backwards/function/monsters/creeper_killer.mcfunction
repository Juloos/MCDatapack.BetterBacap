data modify storage bac_tracker:macro data set value {adv_bac_name:"creeper_killer",adv_full_name:"blazeandcave:monsters/creeper_killer",adv_category:"monsters",adv_extra_categories:[],adv_bac_type:"goal",player_bac_team:"any",member_adv_rank:-1s}
