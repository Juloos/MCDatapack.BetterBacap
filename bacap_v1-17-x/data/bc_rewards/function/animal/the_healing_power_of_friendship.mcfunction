data modify storage bac_tracker:macro data set value {adv_bac_name:"the_healing_power_of_friendship",adv_full_name:"minecraft:husbandry/kill_axolotl_target",adv_category:"animal",adv_extra_categories:[],adv_bac_type:"task",player_bac_team:"any",member_adv_rank:-1s}
