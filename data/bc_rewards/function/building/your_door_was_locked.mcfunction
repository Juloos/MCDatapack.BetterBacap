data modify storage bac_tracker:macro data set value {adv_bac_name:"your_door_was_locked",adv_full_name:"blazeandcave:building/your_door_was_locked",adv_category:"building",adv_extra_categories:[],adv_bac_type:"task",player_bac_team:"any",member_adv_rank:-1s}
