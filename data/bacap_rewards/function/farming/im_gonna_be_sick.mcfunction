data modify storage bac_tracker:macro data set value {adv_bac_name:"im_gonna_be_sick",adv_full_name:"blazeandcave:farming/im_gonna_be_sick",adv_category:"farming",adv_extra_categories:[],adv_bac_type:"goal",player_bac_team:"any",member_adv_rank:-1s}
