data modify storage bac_tracker:macro data set value {adv_bac_name:"serious_dedication",adv_full_name:"minecraft:husbandry/break_diamond_hoe",adv_category:"farming",adv_extra_categories:["trophy"],adv_bac_type:"challenge",player_bac_team:"any",member_adv_rank:-1s}
