data modify storage bac_tracker:macro data set value {adv_bac_name:"good_for_your_bones",adv_full_name:"blazeandcave:mining/good_for_your_bones",adv_category:"mining",adv_extra_categories:[],adv_bac_type:"task",player_bac_team:"any",member_adv_rank:-1s}
