data modify storage bac_tracker:macro data set value {adv_bac_name:"fruit_of_the_looms",adv_full_name:"blazeandcave:building/fruit_of_the_looms",adv_category:"building",adv_extra_categories:["trophy"],adv_bac_type:"challenge",player_bac_team:"any",member_adv_rank:-1s}
