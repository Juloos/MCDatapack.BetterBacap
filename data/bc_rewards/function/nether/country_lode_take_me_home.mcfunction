data modify storage bac_tracker:macro data set value {adv_bac_name:"country_lode_take_me_home",adv_full_name:"minecraft:nether/use_lodestone",adv_category:"nether",adv_extra_categories:[],adv_bac_type:"task",player_bac_team:"any",member_adv_rank:-1s}
