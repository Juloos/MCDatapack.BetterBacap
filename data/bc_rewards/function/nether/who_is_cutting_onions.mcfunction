data modify storage bac_tracker:macro data set value {adv_bac_name:"who_is_cutting_onions",adv_full_name:"minecraft:nether/obtain_crying_obsidian",adv_category:"nether",adv_extra_categories:[],adv_bac_type:"task",player_bac_team:"any",member_adv_rank:-1s}
