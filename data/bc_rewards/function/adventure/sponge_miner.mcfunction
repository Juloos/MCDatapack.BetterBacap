data modify storage bac_tracker:macro data set value {adv_bac_name:"sponge_miner",adv_full_name:"blazeandcave:adventure/sponge_miner",adv_category:"adventure",adv_extra_categories:["trophy"],adv_bac_type:"goal",player_bac_team:"any",member_adv_rank:-1s}
