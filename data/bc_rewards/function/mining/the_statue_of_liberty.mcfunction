data modify storage bac_tracker:macro data set value {adv_bac_name:"the_statue_of_liberty",adv_full_name:"blazeandcave:mining/the_statue_of_liberty",adv_category:"mining",adv_extra_categories:["trophy"],adv_bac_type:"goal",player_bac_team:"any",member_adv_rank:-1s}
