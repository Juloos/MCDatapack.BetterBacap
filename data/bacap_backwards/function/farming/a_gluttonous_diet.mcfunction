data modify storage bac_tracker:macro data set value {adv_bac_name:"a_gluttonous_diet",adv_full_name:"blazeandcave:farming/a_gluttonous_diet",adv_category:"farming",adv_extra_categories:["trophy"],adv_bac_type:"challenge",player_bac_team:"any",member_adv_rank:-1s}
