data modify storage bac_tracker:macro data set value {adv_bac_name:"monster_hunter",adv_full_name:"minecraft:adventure/kill_a_mob",adv_category:"monsters",adv_extra_categories:[],adv_bac_type:"task",player_bac_team:"any",member_adv_rank:-1s}
