data modify storage bac_tracker:macro data set value {adv_bac_name:"everybody_loves_ice",adv_full_name:"blazeandcave:biomes/everybody_loves_ice",adv_category:"biomes",adv_extra_categories:["trophy"],adv_bac_type:"goal",player_bac_team:"any",member_adv_rank:-1s}
