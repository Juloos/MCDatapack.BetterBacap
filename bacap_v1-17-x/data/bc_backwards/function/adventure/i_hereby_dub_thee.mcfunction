data modify storage bac_tracker:macro data set value {adv_bac_name:"i_hereby_dub_thee",adv_full_name:"blazeandcave:adventure/i_hereby_dub_thee",adv_category:"adventure",adv_extra_categories:[],adv_bac_type:"task",player_bac_team:"any",member_adv_rank:-1s}
