data modify storage bac_tracker:macro data set value {adv_bac_name:"portable_storage",adv_full_name:"blazeandcave:end/portable_storage",adv_category:"end",adv_extra_categories:[],adv_bac_type:"task",player_bac_team:"any",member_adv_rank:-1s}
