data modify storage bac_tracker:macro data set value {adv_bac_name:"disc_jockey",adv_full_name:"blazeandcave:adventure/disc_jockey",adv_category:"adventure",adv_extra_categories:[],adv_bac_type:"challenge",player_bac_team:"any",member_adv_rank:-1s}
