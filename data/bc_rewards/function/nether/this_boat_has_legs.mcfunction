data modify storage bac_tracker:macro data set value {adv_bac_name:"this_boat_has_legs",adv_full_name:"minecraft:nether/ride_strider",adv_category:"nether",adv_extra_categories:[],adv_bac_type:"task",player_bac_team:"any",member_adv_rank:-1s}
