data modify storage bac_tracker:macro data set value {adv_bac_name:"amethyst_miner",adv_full_name:"blazeandcave:mining/amethyst_miner",adv_category:"mining",adv_extra_categories:["trophy"],adv_bac_type:"challenge",player_bac_team:"any",member_adv_rank:-1s}
