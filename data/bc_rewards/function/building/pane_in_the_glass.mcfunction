data modify storage bac_tracker:macro data set value {adv_bac_name:"pane_in_the_glass",adv_full_name:"blazeandcave:building/pane_in_the_glass",adv_category:"building",adv_extra_categories:[],adv_bac_type:"goal",player_bac_team:"any",member_adv_rank:-1s}
