data modify storage bac_tracker:macro data set value {adv_bac_name:"no_dont_let_me_leave_murph",adv_full_name:"blazeandcave:end/no_dont_let_me_leave_murph",adv_category:"end",adv_extra_categories:["trophy"],adv_bac_type:"challenge",player_bac_team:"any",member_adv_rank:-1s}
