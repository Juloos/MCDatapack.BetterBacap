data modify storage bac_tracker:macro data set value {adv_bac_name:"master_axeman",adv_full_name:"blazeandcave:enchanting/master_axeman",adv_category:"enchanting",adv_extra_categories:[],adv_bac_type:"challenge",player_bac_team:"any",member_adv_rank:-1s}
