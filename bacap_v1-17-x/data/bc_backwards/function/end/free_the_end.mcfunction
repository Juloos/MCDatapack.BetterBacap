data modify storage bac_tracker:macro data set value {adv_bac_name:"free_the_end",adv_full_name:"minecraft:end/kill_dragon",adv_category:"end",adv_extra_categories:[],adv_bac_type:"goal",player_bac_team:"any",member_adv_rank:-1s}
