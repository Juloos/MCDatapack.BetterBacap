data modify storage bac_tracker:macro data set value {adv_bac_name:"uneasy_alliance",adv_full_name:"minecraft:nether/uneasy_alliance",adv_category:"nether",adv_extra_categories:[],adv_bac_type:"challenge",player_bac_team:"any",member_adv_rank:-1s}
