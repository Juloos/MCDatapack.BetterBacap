data modify storage bac_tracker:macro data set value {adv_bac_name:"warden_extinction",adv_full_name:"blazeandcave:weaponry/warden_extinction",adv_category:"weaponry",adv_extra_categories:[],adv_bac_type:"challenge",player_bac_team:"any",member_adv_rank:-1s}
