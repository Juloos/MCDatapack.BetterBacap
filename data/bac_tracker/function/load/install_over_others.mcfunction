scoreboard players set installed bac_tracker.config 1
...
$datapack disable "file/BacapTracker-$(version)_Bacap-$(bacap)_Minecraft-$(minecraft).zip"
$datapack enable "file/BacapTracker-$(version)_Bacap-$(bacap)_Minecraft-$(minecraft).zip" last
