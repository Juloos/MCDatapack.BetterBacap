data modify storage bac_tracker:macro data set value {adv_bac_name:"still_talking",adv_full_name:"blazeandcave:monsters/still_talking",adv_category:"monsters",adv_extra_categories:[],adv_bac_type:"challenge",player_bac_team:"any",member_adv_rank:-1s}
