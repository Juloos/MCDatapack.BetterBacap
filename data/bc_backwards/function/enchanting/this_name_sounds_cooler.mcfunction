data modify storage bac_tracker:macro data set value {adv_bac_name:"this_name_sounds_cooler",adv_full_name:"blazeandcave:enchanting/this_name_sounds_cooler",adv_category:"enchanting",adv_extra_categories:[],adv_bac_type:"task",player_bac_team:"any",member_adv_rank:-1s}
