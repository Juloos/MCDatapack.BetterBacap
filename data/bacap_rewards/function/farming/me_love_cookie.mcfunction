data modify storage bac_tracker:macro data set value {adv_bac_name:"me_love_cookie",adv_full_name:"blazeandcave:farming/me_love_cookie",adv_category:"farming",adv_extra_categories:[],adv_bac_type:"task",player_bac_team:"any",member_adv_rank:-1s}
