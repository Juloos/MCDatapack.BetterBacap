data modify storage bac_tracker:macro data set value {adv_bac_name:"boing_boing",adv_full_name:"blazeandcave:statistics/boing_boing",adv_category:"statistics",adv_extra_categories:[],adv_bac_type:"goal",player_bac_team:"any",member_adv_rank:-1s}
