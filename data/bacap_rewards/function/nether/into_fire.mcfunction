data modify storage bac_tracker:macro data set value {adv_bac_name:"into_fire",adv_full_name:"minecraft:nether/obtain_blaze_rod",adv_category:"nether",adv_extra_categories:[],adv_bac_type:"task",player_bac_team:"any",member_adv_rank:-1s}
