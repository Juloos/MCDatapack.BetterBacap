data modify storage bac_tracker:macro data set value {adv_bac_name:"hot_spring",adv_full_name:"blazeandcave:nether/hot_spring",adv_category:"nether",adv_extra_categories:[],adv_bac_type:"task",player_bac_team:"any",member_adv_rank:-1s}
