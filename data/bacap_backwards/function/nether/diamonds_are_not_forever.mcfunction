data modify storage bac_tracker:macro data set value {adv_bac_name:"diamonds_are_not_forever",adv_full_name:"blazeandcave:nether/diamonds_are_not_forever",adv_category:"nether",adv_extra_categories:[],adv_bac_type:"task",player_bac_team:"any",member_adv_rank:-1s}
