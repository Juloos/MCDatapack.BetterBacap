data modify storage bac_tracker:macro data set value {adv_bac_name:"im_in_lava_with_you",adv_full_name:"blazeandcave:nether/im_in_lava_with_you",adv_category:"nether",adv_extra_categories:[],adv_bac_type:"goal",player_bac_team:"any",member_adv_rank:-1s}
