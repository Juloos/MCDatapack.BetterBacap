data modify storage bac_tracker:macro data set value {adv_bac_name:"retro_future_knight",adv_full_name:"blazeandcave:adventure/retro_future_knight",adv_category:"adventure",adv_extra_categories:[],adv_bac_type:"goal",player_bac_team:"any",member_adv_rank:-1s}
