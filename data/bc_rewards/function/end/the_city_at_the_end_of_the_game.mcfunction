data modify storage bac_tracker:macro data set value {adv_bac_name:"the_city_at_the_end_of_the_game",adv_full_name:"minecraft:end/find_end_city",adv_category:"end",adv_extra_categories:[],adv_bac_type:"task",player_bac_team:"any",member_adv_rank:-1s}
