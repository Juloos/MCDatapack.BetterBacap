data modify storage bac_tracker:macro data set value {adv_bac_name:"scientific_inaccuracy",adv_full_name:"blazeandcave:farming/scientific_inaccuracy",adv_category:"farming",adv_extra_categories:[],adv_bac_type:"task",player_bac_team:"any",member_adv_rank:-1s}
