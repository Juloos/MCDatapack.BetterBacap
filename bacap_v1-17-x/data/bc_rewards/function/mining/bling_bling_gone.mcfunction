data modify storage bac_tracker:macro data set value {adv_bac_name:"bling_bling_gone",adv_full_name:"blazeandcave:mining/bling_bling_gone",adv_category:"mining",adv_extra_categories:[],adv_bac_type:"goal",player_bac_team:"any",member_adv_rank:-1s}
