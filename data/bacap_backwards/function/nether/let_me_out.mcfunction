data modify storage bac_tracker:macro data set value {adv_bac_name:"let_me_out",adv_full_name:"blazeandcave:nether/let_me_out",adv_category:"nether",adv_extra_categories:[],adv_bac_type:"challenge",player_bac_team:"any",member_adv_rank:-1s}
