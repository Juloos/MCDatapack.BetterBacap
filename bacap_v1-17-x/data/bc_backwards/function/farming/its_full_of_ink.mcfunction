data modify storage bac_tracker:macro data set value {adv_bac_name:"its_full_of_ink",adv_full_name:"blazeandcave:farming/its_full_of_ink",adv_category:"farming",adv_extra_categories:[],adv_bac_type:"task",player_bac_team:"any",member_adv_rank:-1s}
