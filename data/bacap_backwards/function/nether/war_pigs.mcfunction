data modify storage bac_tracker:macro data set value {adv_bac_name:"war_pigs",adv_full_name:"minecraft:nether/loot_bastion",adv_category:"nether",adv_extra_categories:[],adv_bac_type:"task",player_bac_team:"any",member_adv_rank:-1s}
