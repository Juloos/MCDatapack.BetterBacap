data modify storage bac_tracker:macro data set value {adv_bac_name:"combine_harvester",adv_full_name:"blazeandcave:farming/combine_harvester",adv_category:"farming",adv_extra_categories:[],adv_bac_type:"challenge",player_bac_team:"any",member_adv_rank:-1s}
