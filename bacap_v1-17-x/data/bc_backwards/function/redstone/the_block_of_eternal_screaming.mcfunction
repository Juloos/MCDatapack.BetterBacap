data modify storage bac_tracker:macro data set value {adv_bac_name:"the_block_of_eternal_screaming",adv_full_name:"blazeandcave:redstone/the_block_of_eternal_screaming",adv_category:"redstone",adv_extra_categories:["trophy"],adv_bac_type:"goal",player_bac_team:"any",member_adv_rank:-1s}
