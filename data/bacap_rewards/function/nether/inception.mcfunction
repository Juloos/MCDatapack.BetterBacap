data modify storage bac_tracker:macro data set value {adv_bac_name:"inception",adv_full_name:"blazeandcave:nether/inception",adv_category:"nether",adv_extra_categories:["trophy"],adv_bac_type:"challenge",player_bac_team:"any",member_adv_rank:-1s}
