data modify storage bac_tracker:macro data set value {adv_bac_name:"tricky_treasures",adv_full_name:"blazeandcave:adventure/tricky_treasures",adv_category:"adventure",adv_extra_categories:[],adv_bac_type:"goal",player_bac_team:"any",member_adv_rank:-1s}
