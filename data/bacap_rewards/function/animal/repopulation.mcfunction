data modify storage bac_tracker:macro data set value {adv_bac_name:"repopulation",adv_full_name:"minecraft:husbandry/breed_an_animal",adv_category:"animal",adv_extra_categories:[],adv_bac_type:"task",player_bac_team:"any",member_adv_rank:-1s}
