data modify storage bac_tracker:macro data set value {adv_bac_name:"a_balanced_diet",adv_full_name:"minecraft:husbandry/balanced_diet",adv_category:"farming",adv_extra_categories:[],adv_bac_type:"challenge",player_bac_team:"any",member_adv_rank:-1s}
