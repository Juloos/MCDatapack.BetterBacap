data modify storage bac_tracker:macro data set value {adv_bac_name:"sneaky_snitch",adv_full_name:"blazeandcave:statistics/sneaky_snitch",adv_category:"statistics",adv_extra_categories:[],adv_bac_type:"task",player_bac_team:"any",member_adv_rank:-1s}
