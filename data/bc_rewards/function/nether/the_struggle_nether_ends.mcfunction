data modify storage bac_tracker:macro data set value {adv_bac_name:"the_struggle_nether_ends",adv_full_name:"blazeandcave:nether/the_struggle_nether_ends",adv_category:"nether",adv_extra_categories:[],adv_bac_type:"challenge",player_bac_team:"any",member_adv_rank:-1s}
