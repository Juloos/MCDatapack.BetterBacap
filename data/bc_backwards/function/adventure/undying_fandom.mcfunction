data modify storage bac_tracker:macro data set value {adv_bac_name:"undying_fandom",adv_full_name:"blazeandcave:adventure/undying_fandom",adv_category:"adventure",adv_extra_categories:["trophy"],adv_bac_type:"challenge",player_bac_team:"any",member_adv_rank:-1s}
