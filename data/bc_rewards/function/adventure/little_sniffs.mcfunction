data modify storage bac_tracker:macro data set value {adv_bac_name:"little_sniffs",adv_full_name:"minecraft:husbandry/feed_snifflet",adv_category:"adventure",adv_extra_categories:[],adv_bac_type:"task",player_bac_team:"any",member_adv_rank:-1s}
