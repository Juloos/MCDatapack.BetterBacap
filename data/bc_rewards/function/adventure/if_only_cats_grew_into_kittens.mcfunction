data modify storage bac_tracker:macro data set value {adv_bac_name:"if_only_cats_grew_into_kittens",adv_full_name:"blazeandcave:adventure/if_only_cats_grew_into_kittens",adv_category:"adventure",adv_extra_categories:[],adv_bac_type:"task",player_bac_team:"any",member_adv_rank:-1s}
