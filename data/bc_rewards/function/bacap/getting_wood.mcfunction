data modify storage bac_tracker:macro data set value {adv_bac_name:"getting_wood",adv_full_name:"blazeandcave:bacap/getting_wood",adv_category:"bacap",adv_extra_categories:[],adv_bac_type:"task",player_bac_team:"any",member_adv_rank:-1s}
