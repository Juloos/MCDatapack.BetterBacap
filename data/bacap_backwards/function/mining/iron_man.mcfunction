data modify storage bac_tracker:macro data set value {adv_bac_name:"iron_man",adv_full_name:"blazeandcave:mining/iron_man",adv_category:"mining",adv_extra_categories:[],adv_bac_type:"goal",player_bac_team:"any",member_adv_rank:-1s}
