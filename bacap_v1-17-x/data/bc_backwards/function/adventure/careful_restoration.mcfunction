data modify storage bac_tracker:macro data set value {adv_bac_name:"careful_restoration",adv_full_name:"minecraft:adventure/craft_decorated_pot_using_only_sherds",adv_category:"adventure",adv_extra_categories:[],adv_bac_type:"goal",player_bac_team:"any",member_adv_rank:-1s}
