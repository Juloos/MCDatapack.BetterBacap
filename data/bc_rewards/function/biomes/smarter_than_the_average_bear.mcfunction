data modify storage bac_tracker:macro data set value {adv_bac_name:"smarter_than_the_average_bear",adv_full_name:"blazeandcave:biomes/smarter_than_the_average_bear",adv_category:"biomes",adv_extra_categories:["terralith"],adv_bac_type:"task",player_bac_team:"any",member_adv_rank:-1s}
