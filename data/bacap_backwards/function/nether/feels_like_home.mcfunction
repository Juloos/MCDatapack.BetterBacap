data modify storage bac_tracker:macro data set value {adv_bac_name:"feels_like_home",adv_full_name:"minecraft:nether/ride_strider_in_overworld_lava",adv_category:"nether",adv_extra_categories:[],adv_bac_type:"goal",player_bac_team:"any",member_adv_rank:-1s}
