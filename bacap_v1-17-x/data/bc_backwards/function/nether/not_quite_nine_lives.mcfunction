data modify storage bac_tracker:macro data set value {adv_bac_name:"not_quite_nine_lives",adv_full_name:"minecraft:nether/charge_respawn_anchor",adv_category:"nether",adv_extra_categories:[],adv_bac_type:"goal",player_bac_team:"any",member_adv_rank:-1s}
