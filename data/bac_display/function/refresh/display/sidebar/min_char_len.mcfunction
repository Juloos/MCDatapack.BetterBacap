...
$function utils:range_loop_macro_without_i {macro:"bac_display:refresh/display/sidebar/macro/min_char_len",from:0,to:$(min_char_len),data:{team:"$(team)"}}
...
function bac_display:refresh/display/sidebar/macro/min_char_len_end with storage bac_display:macro data
