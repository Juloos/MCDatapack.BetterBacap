data modify storage bac_tracker:macro data set value {adv_bac_name:"x_bow",adv_full_name:"blazeandcave:weaponry/x_bow",adv_category:"weaponry",adv_extra_categories:[],adv_bac_type:"task",player_bac_team:"any",member_adv_rank:-1s}
