data modify storage bac_tracker:macro data set value {adv_bac_name:"music_to_my_ears",adv_full_name:"blazeandcave:adventure/music_to_my_ears",adv_category:"adventure",adv_extra_categories:[],adv_bac_type:"task",player_bac_team:"any",member_adv_rank:-1s}
