data modify storage bac_tracker:macro data set value {adv_bac_name:"battle_of_the_bands",adv_full_name:"blazeandcave:animal/battle_of_the_bands",adv_category:"animal",adv_extra_categories:[],adv_bac_type:"goal",player_bac_team:"any",member_adv_rank:-1s}
