data modify storage bac_tracker:macro data set value {adv_bac_name:"you_are_the_pillager",adv_full_name:"blazeandcave:adventure/you_are_the_pillager",adv_category:"adventure",adv_extra_categories:["trophy"],adv_bac_type:"challenge",player_bac_team:"any",member_adv_rank:-1s}
