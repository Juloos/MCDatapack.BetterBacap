data modify storage bac_tracker:macro data set value {adv_bac_name:"a_soul_for_a_soul",adv_full_name:"blazeandcave:nether/a_soul_for_a_soul",adv_category:"nether",adv_extra_categories:[],adv_bac_type:"task",player_bac_team:"any",member_adv_rank:-1s}
