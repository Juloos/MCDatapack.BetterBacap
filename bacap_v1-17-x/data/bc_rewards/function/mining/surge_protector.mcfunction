data modify storage bac_tracker:macro data set value {adv_bac_name:"surge_protector",adv_full_name:"minecraft:adventure/lightning_rod_with_villager_no_fire",adv_category:"mining",adv_extra_categories:[],adv_bac_type:"goal",player_bac_team:"any",member_adv_rank:-1s}
