data modify storage bac_tracker:macro data set value {adv_bac_name:"a_suspicious_advancement",adv_full_name:"blazeandcave:adventure/a_suspicious_advancement",adv_category:"adventure",adv_extra_categories:[],adv_bac_type:"goal",player_bac_team:"any",member_adv_rank:-1s}
