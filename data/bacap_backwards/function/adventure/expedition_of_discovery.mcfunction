data modify storage bac_tracker:macro data set value {adv_bac_name:"expedition_of_discovery",adv_full_name:"blazeandcave:adventure/expedition_of_discovery",adv_category:"adventure",adv_extra_categories:["hidden","terralith"],adv_bac_type:"challenge",player_bac_team:"any",member_adv_rank:-1s}
