data modify storage bac_tracker:macro data set value {adv_bac_name:"ill_be_back",adv_full_name:"blazeandcave:enchanting/ill_be_back",adv_category:"enchanting",adv_extra_categories:[],adv_bac_type:"task",player_bac_team:"any",member_adv_rank:-1s}
