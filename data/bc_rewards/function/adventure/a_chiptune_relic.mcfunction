data modify storage bac_tracker:macro data set value {adv_bac_name:"a_chiptune_relic",adv_full_name:"blazeandcave:adventure/a_chiptune_relic",adv_category:"adventure",adv_extra_categories:[],adv_bac_type:"goal",player_bac_team:"any",member_adv_rank:-1s}
