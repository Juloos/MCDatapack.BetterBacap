data modify storage bac_tracker:macro data set value {adv_bac_name:"a_journey_begins",adv_full_name:"blazeandcave:adventure/a_journey_begins",adv_category:"adventure",adv_extra_categories:["hidden","terralith"],adv_bac_type:"task",player_bac_team:"any",member_adv_rank:-1s}
