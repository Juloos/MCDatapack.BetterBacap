data modify storage bac_tracker:macro data set value {adv_bac_name:"were_in_the_endgame_now",adv_full_name:"blazeandcave:challenges/were_in_the_endgame_now",adv_category:"challenges",adv_extra_categories:["trophy"],adv_bac_type:"challenge",player_bac_team:"any",member_adv_rank:-1s}
