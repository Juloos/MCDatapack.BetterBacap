data modify storage bac_tracker:macro data set value {adv_bac_name:"not_today_thank_you",adv_full_name:"minecraft:story/deflect_arrow",adv_category:"monsters",adv_extra_categories:[],adv_bac_type:"task",player_bac_team:"any",member_adv_rank:-1s}
