data modify storage bac_tracker:macro data set value {adv_bac_name:"giga_xp_grinder",adv_full_name:"blazeandcave:statistics/giga_xp_grinder",adv_category:"statistics",adv_extra_categories:["hidden","trophy"],adv_bac_type:"challenge",player_bac_team:"any",member_adv_rank:-1s}
