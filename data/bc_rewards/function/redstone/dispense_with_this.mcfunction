data modify storage bac_tracker:macro data set value {adv_bac_name:"dispense_with_this",adv_full_name:"blazeandcave:redstone/dispense_with_this",adv_category:"redstone",adv_extra_categories:[],adv_bac_type:"task",player_bac_team:"any",member_adv_rank:-1s}
