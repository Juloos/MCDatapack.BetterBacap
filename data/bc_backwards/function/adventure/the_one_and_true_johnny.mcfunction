data modify storage bac_tracker:macro data set value {adv_bac_name:"the_one_and_true_johnny",adv_full_name:"blazeandcave:adventure/the_one_and_true_johnny",adv_category:"adventure",adv_extra_categories:[],adv_bac_type:"goal",player_bac_team:"any",member_adv_rank:-1s}
