data modify storage bac_tracker:macro data set value {adv_bac_name:"o_land_o_bloom",adv_full_name:"blazeandcave:biomes/o_land_o_bloom",adv_category:"biomes",adv_extra_categories:["terralith"],adv_bac_type:"task",player_bac_team:"any",member_adv_rank:-1s}
