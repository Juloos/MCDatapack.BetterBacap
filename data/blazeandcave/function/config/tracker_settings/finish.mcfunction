...
# Refresh rate
tellraw @a ["",{"text":"[+10]","color":"green","clickEvent":{"action":"run_command","value":"/function blazeandcave:config/tracker_settings/target_refresh_time_add_10"},"hoverEvent":{"action":"show_text","contents":["",{"translate":"Click to add 10","color":"gold"}]}}," ",{"text":"[set]","color":"yellow","clickEvent":{"action":"suggest_command","value":"/function blazeandcave:config/tracker_settings/target_refresh_time_custom {new_value:XXX}"},"hoverEvent":{"action":"show_text","contents":["",{"translate":"Click to manually modify","color":"gold"}]}}," ",{"text":"[-10]","color":"red","clickEvent":{"action":"run_command","value":"/function blazeandcave:config/tracker_settings/target_refresh_time_remove_10"},"hoverEvent":{"action":"show_text","contents":["",{"translate":"Click to remove 10","color":"gold"}]}},{"text":" Refresh rate: "},{"score":{"name":"target_refresh_time","objective":"bac_tracker.config"},"color":"yellow"},{"text":"t","color":"yellow"}]
# Refresh type
$tellraw @a ["",$(refresh_type_toggles),{"text":" Refresh type: "},{"text":"$(refresh_type_description)","color":"yellow"}]
# Refresh on load
