data modify storage bac_tracker:macro data set value {adv_bac_name:"under_the_ice",adv_full_name:"blazeandcave:adventure/under_the_ice",adv_category:"adventure",adv_extra_categories:["terralith"],adv_bac_type:"goal",player_bac_team:"any",member_adv_rank:-1s}
