data modify storage bac_tracker:macro data set value {adv_bac_name:"a_seedy_place",adv_full_name:"minecraft:husbandry/plant_seed",adv_category:"farming",adv_extra_categories:[],adv_bac_type:"task",player_bac_team:"any",member_adv_rank:-1s}
