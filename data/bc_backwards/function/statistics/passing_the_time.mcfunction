data modify storage bac_tracker:macro data set value {adv_bac_name:"passing_the_time",adv_full_name:"blazeandcave:statistics/passing_the_time",adv_category:"statistics",adv_extra_categories:[],adv_bac_type:"goal",player_bac_team:"any",member_adv_rank:-1s}
