data modify storage bac_tracker:macro data set value {adv_bac_name:"somewhere_over_the_rainbow",adv_full_name:"blazeandcave:end/somewhere_over_the_rainbow",adv_category:"end",adv_extra_categories:[],adv_bac_type:"goal",player_bac_team:"any",member_adv_rank:-1s}
