data modify storage bac_tracker:macro data set value {adv_bac_name:"god_of_thunder",adv_full_name:"blazeandcave:enchanting/god_of_thunder",adv_category:"enchanting",adv_extra_categories:[],adv_bac_type:"goal",player_bac_team:"any",member_adv_rank:-1s}
