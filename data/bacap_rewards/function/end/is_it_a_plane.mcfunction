data modify storage bac_tracker:macro data set value {adv_bac_name:"is_it_a_plane",adv_full_name:"minecraft:adventure/spyglass_at_dragon",adv_category:"end",adv_extra_categories:[],adv_bac_type:"task",player_bac_team:"any",member_adv_rank:-1s}
