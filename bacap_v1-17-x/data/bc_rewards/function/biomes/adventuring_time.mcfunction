data modify storage bac_tracker:macro data set value {adv_bac_name:"adventuring_time",adv_full_name:"minecraft:adventure/adventuring_time",adv_category:"biomes",adv_extra_categories:[],adv_bac_type:"challenge",player_bac_team:"any",member_adv_rank:-1s}
