data modify storage bac_tracker:macro data set value {adv_bac_name:"come_to_the_countryside",adv_full_name:"blazeandcave:farming/come_to_the_countryside",adv_category:"farming",adv_extra_categories:["trophy"],adv_bac_type:"goal",player_bac_team:"any",member_adv_rank:-1s}
