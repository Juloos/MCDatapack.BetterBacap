data modify storage bac_tracker:macro data set value {adv_bac_name:"there_it_goes",adv_full_name:"blazeandcave:weaponry/there_it_goes",adv_category:"weaponry",adv_extra_categories:["trophy"],adv_bac_type:"challenge",player_bac_team:"any",member_adv_rank:-1s}
