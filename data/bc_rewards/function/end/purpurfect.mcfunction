data modify storage bac_tracker:macro data set value {adv_bac_name:"purpurfect",adv_full_name:"blazeandcave:end/purpurfect",adv_category:"end",adv_extra_categories:[],adv_bac_type:"task",player_bac_team:"any",member_adv_rank:-1s}
