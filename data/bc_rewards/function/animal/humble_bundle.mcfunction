data modify storage bac_tracker:macro data set value {adv_bac_name:"humble_bundle",adv_full_name:"blazeandcave:animal/humble_bundle",adv_category:"animal",adv_extra_categories:["hidden"],adv_bac_type:"task",player_bac_team:"any",member_adv_rank:-1s}
