data modify storage bac_tracker:macro data set value {adv_bac_name:"cow_jumped_over_the_moon",adv_full_name:"blazeandcave:end/cow_jumped_over_the_moon",adv_category:"end",adv_extra_categories:["trophy"],adv_bac_type:"challenge",player_bac_team:"any",member_adv_rank:-1s}
