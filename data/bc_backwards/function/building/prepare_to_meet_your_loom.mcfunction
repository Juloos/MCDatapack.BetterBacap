data modify storage bac_tracker:macro data set value {adv_bac_name:"prepare_to_meet_your_loom",adv_full_name:"blazeandcave:building/prepare_to_meet_your_loom",adv_category:"building",adv_extra_categories:[],adv_bac_type:"task",player_bac_team:"any",member_adv_rank:-1s}
