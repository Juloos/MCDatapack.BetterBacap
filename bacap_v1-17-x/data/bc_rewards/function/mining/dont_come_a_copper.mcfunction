data modify storage bac_tracker:macro data set value {adv_bac_name:"dont_come_a_copper",adv_full_name:"blazeandcave:mining/dont_come_a_copper",adv_category:"mining",adv_extra_categories:[],adv_bac_type:"task",player_bac_team:"any",member_adv_rank:-1s}
