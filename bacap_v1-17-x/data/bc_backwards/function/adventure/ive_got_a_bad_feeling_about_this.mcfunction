data modify storage bac_tracker:macro data set value {adv_bac_name:"ive_got_a_bad_feeling_about_this",adv_full_name:"minecraft:adventure/voluntary_exile",adv_category:"adventure",adv_extra_categories:[],adv_bac_type:"task",player_bac_team:"any",member_adv_rank:-1s}
