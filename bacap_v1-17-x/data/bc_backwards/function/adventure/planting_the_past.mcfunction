data modify storage bac_tracker:macro data set value {adv_bac_name:"planting_the_past",adv_full_name:"minecraft:husbandry/plant_any_sniffer_seed",adv_category:"adventure",adv_extra_categories:[],adv_bac_type:"task",player_bac_team:"any",member_adv_rank:-1s}
