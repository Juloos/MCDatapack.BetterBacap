data modify storage bac_tracker:macro data set value {adv_bac_name:"nether_say_die",adv_full_name:"minecraft:nether/obtain_ancient_debris",adv_category:"nether",adv_extra_categories:[],adv_bac_type:"task",player_bac_team:"any",member_adv_rank:-1s}
