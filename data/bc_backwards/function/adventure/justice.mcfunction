data modify storage bac_tracker:macro data set value {adv_bac_name:"justice",adv_full_name:"blazeandcave:adventure/justice",adv_category:"adventure",adv_extra_categories:["trophy"],adv_bac_type:"challenge",player_bac_team:"any",member_adv_rank:-1s}
