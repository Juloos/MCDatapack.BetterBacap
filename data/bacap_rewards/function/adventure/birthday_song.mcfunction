data modify storage bac_tracker:macro data set value {adv_bac_name:"birthday_song",adv_full_name:"minecraft:husbandry/allay_deliver_cake_to_note_block",adv_category:"adventure",adv_extra_categories:[],adv_bac_type:"goal",player_bac_team:"any",member_adv_rank:-1s}
