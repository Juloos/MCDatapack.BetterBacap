data modify storage bac_tracker:macro data set value {adv_bac_name:"spire_of_ice",adv_full_name:"blazeandcave:adventure/spire_of_ice",adv_category:"adventure",adv_extra_categories:["terralith"],adv_bac_type:"goal",player_bac_team:"any",member_adv_rank:-1s}
