data modify storage bac_tracker:macro data set value {adv_bac_name:"it_spreads",adv_full_name:"minecraft:adventure/kill_mob_near_sculk_catalyst",adv_category:"mining",adv_extra_categories:[],adv_bac_type:"task",player_bac_team:"any",member_adv_rank:-1s}
