data modify storage bac_tracker:macro data set value {adv_bac_name:"oh_shiny",adv_full_name:"minecraft:nether/distract_piglin",adv_category:"nether",adv_extra_categories:[],adv_bac_type:"task",player_bac_team:"any",member_adv_rank:-1s}
