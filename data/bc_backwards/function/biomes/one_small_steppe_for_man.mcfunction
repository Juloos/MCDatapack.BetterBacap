data modify storage bac_tracker:macro data set value {adv_bac_name:"one_small_steppe_for_man",adv_full_name:"blazeandcave:biomes/one_small_steppe_for_man",adv_category:"biomes",adv_extra_categories:["terralith"],adv_bac_type:"task",player_bac_team:"any",member_adv_rank:-1s}
