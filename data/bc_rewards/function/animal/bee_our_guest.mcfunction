data modify storage bac_tracker:macro data set value {adv_bac_name:"bee_our_guest",adv_full_name:"minecraft:husbandry/safely_harvest_honey",adv_category:"animal",adv_extra_categories:[],adv_bac_type:"task",player_bac_team:"any",member_adv_rank:-1s}
