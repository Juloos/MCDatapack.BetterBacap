data modify storage bac_tracker:macro data set value {adv_bac_name:"a_complete_catalogue",adv_full_name:"minecraft:husbandry/complete_catalogue",adv_category:"adventure",adv_extra_categories:["trophy"],adv_bac_type:"challenge",player_bac_team:"any",member_adv_rank:-1s}
