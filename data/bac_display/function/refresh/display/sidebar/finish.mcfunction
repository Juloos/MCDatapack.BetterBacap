...
$execute unless score page_size.$(team) bac_display.config matches 1.. run return 1
...
$execute unless score page_size.$(team) bac_display.config matches 2.. run return 2
...
$execute unless score page_size.$(team) bac_display.config matches 3.. run return 3
...
$execute unless score page_size.$(team) bac_display.config matches 4.. run return 4
...
$execute unless score page_size.$(team) bac_display.config matches 5.. run return 5
...
$execute unless score page_size.$(team) bac_display.config matches 6.. run return 6
...
$execute unless score page_size.$(team) bac_display.config matches 7.. run return 7
...
$execute unless score page_size.$(team) bac_display.config matches 8.. run return 8
...
$execute unless score page_size.$(team) bac_display.config matches 9.. run return 9
...
$execute unless score page_size.$(team) bac_display.config matches 10.. run return 10
...
$execute unless score page_size.$(team) bac_display.config matches 11.. run return 11
...
$execute unless score page_size.$(team) bac_display.config matches 12.. run return 12
...
$execute unless score page_size.$(team) bac_display.config matches 13.. run return 13
...
$execute unless score page_size.$(team) bac_display.config matches 14.. run return 14
...
$execute unless score page_size.$(team) bac_display.config matches 15.. run return 15
