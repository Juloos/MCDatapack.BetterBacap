data modify storage bac_tracker:macro data set value {adv_bac_name:"professor_birch",adv_full_name:"blazeandcave:building/professor_birch",adv_category:"building",adv_extra_categories:[],adv_bac_type:"goal",player_bac_team:"any",member_adv_rank:-1s}
