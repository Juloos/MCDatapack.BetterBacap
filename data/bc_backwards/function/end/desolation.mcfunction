data modify storage bac_tracker:macro data set value {adv_bac_name:"desolation",adv_full_name:"nullscape:root",adv_category:"end",adv_extra_categories:["terralith"],adv_bac_type:"goal",player_bac_team:"any",member_adv_rank:-1s}
