data modify storage bac_tracker:macro data set value {adv_bac_name:"handsome_jack",adv_full_name:"blazeandcave:monsters/handsome_jack",adv_category:"monsters",adv_extra_categories:["hidden","trophy"],adv_bac_type:"challenge",player_bac_team:"any",member_adv_rank:-1s}
