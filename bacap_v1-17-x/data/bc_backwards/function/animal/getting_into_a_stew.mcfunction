data modify storage bac_tracker:macro data set value {adv_bac_name:"getting_into_a_stew",adv_full_name:"blazeandcave:animal/getting_into_a_stew",adv_category:"animal",adv_extra_categories:[],adv_bac_type:"task",player_bac_team:"any",member_adv_rank:-1s}
