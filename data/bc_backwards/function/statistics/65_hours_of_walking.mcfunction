data modify storage bac_tracker:macro data set value {adv_bac_name:"65_hours_of_walking",adv_full_name:"blazeandcave:statistics/65_hours_of_walking",adv_category:"statistics",adv_extra_categories:["hidden","trophy"],adv_bac_type:"challenge",player_bac_team:"any",member_adv_rank:-1s}
