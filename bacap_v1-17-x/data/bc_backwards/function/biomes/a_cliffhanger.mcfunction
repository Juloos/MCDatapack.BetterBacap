data modify storage bac_tracker:macro data set value {adv_bac_name:"a_cliffhanger",adv_full_name:"blazeandcave:biomes/a_cliffhanger",adv_category:"biomes",adv_extra_categories:["terralith"],adv_bac_type:"goal",player_bac_team:"any",member_adv_rank:-1s}
