data modify storage bac_tracker:macro data set value {adv_bac_name:"target_practise",adv_full_name:"blazeandcave:redstone/target_practise",adv_category:"redstone",adv_extra_categories:[],adv_bac_type:"goal",player_bac_team:"any",member_adv_rank:-1s}
