data modify storage bac_tracker:macro data set value {adv_bac_name:"jenga",adv_full_name:"blazeandcave:nether/jenga",adv_category:"nether",adv_extra_categories:[],adv_bac_type:"goal",player_bac_team:"any",member_adv_rank:-1s}
