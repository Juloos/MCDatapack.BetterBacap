data modify storage bac_tracker:macro data set value {adv_bac_name:"crazy_cat_lady",adv_full_name:"blazeandcave:adventure/crazy_cat_lady",adv_category:"adventure",adv_extra_categories:[],adv_bac_type:"task",player_bac_team:"any",member_adv_rank:-1s}
