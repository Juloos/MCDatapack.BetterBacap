data modify storage bac_tracker:macro data set value {adv_bac_name:"whatever_floats_your_goat",adv_full_name:"minecraft:husbandry/ride_a_boat_with_a_goat",adv_category:"animal",adv_extra_categories:[],adv_bac_type:"task",player_bac_team:"any",member_adv_rank:-1s}
