data modify storage bac_tracker:macro data set value {adv_bac_name:"wheres_the_honey_lebowski",adv_full_name:"blazeandcave:animal/wheres_the_honey_lebowski",adv_category:"animal",adv_extra_categories:["trophy"],adv_bac_type:"challenge",player_bac_team:"any",member_adv_rank:-1s}
