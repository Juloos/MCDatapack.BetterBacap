data modify storage bac_tracker:macro data set value {adv_bac_name:"travelling_bard",adv_full_name:"blazeandcave:redstone/travelling_bard",adv_category:"redstone",adv_extra_categories:["trophy"],adv_bac_type:"challenge",player_bac_team:"any",member_adv_rank:-1s}
