data modify storage bac_tracker:macro data set value {adv_bac_name:"creepers_and_withers",adv_full_name:"blazeandcave:building/creepers_and_withers",adv_category:"building",adv_extra_categories:[],adv_bac_type:"task",player_bac_team:"any",member_adv_rank:-1s}
