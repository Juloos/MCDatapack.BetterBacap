data modify storage bac_tracker:macro data set value {adv_bac_name:"laser_sharks",adv_full_name:"blazeandcave:adventure/laser_sharks",adv_category:"adventure",adv_extra_categories:[],adv_bac_type:"task",player_bac_team:"any",member_adv_rank:-1s}
