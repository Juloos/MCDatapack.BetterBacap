data modify storage bac_tracker:macro data set value {adv_bac_name:"i_yearned_for_the_mines",adv_full_name:"blazeandcave:mining/i_yearned_for_the_mines",adv_category:"mining",adv_extra_categories:["trophy"],adv_bac_type:"challenge",player_bac_team:"any",member_adv_rank:-1s}
