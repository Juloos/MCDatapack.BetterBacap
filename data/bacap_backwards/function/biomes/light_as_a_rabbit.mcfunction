data modify storage bac_tracker:macro data set value {adv_bac_name:"light_as_a_rabbit",adv_full_name:"minecraft:adventure/walk_on_powder_snow_with_leather_boots",adv_category:"biomes",adv_extra_categories:[],adv_bac_type:"task",player_bac_team:"any",member_adv_rank:-1s}
