data modify storage bac_tracker:macro data set value {adv_bac_name:"level_up",adv_full_name:"blazeandcave:statistics/level_up",adv_category:"statistics",adv_extra_categories:[],adv_bac_type:"task",player_bac_team:"any",member_adv_rank:-1s}
