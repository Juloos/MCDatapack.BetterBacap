data modify storage bac_tracker:macro data set value {adv_bac_name:"chestful_of_cobblestone",adv_full_name:"blazeandcave:mining/chestful_of_cobblestone",adv_category:"mining",adv_extra_categories:["trophy"],adv_bac_type:"goal",player_bac_team:"any",member_adv_rank:-1s}
