data modify storage bac_tracker:macro data set value {adv_bac_name:"mary_had_a_little_lamb",adv_full_name:"blazeandcave:animal/mary_had_a_little_lamb",adv_category:"animal",adv_extra_categories:[],adv_bac_type:"task",player_bac_team:"any",member_adv_rank:-1s}
