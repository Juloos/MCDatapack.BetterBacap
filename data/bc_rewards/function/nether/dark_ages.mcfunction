data modify storage bac_tracker:macro data set value {adv_bac_name:"dark_ages",adv_full_name:"blazeandcave:nether/dark_ages",adv_category:"nether",adv_extra_categories:[],adv_bac_type:"task",player_bac_team:"any",member_adv_rank:-1s}
