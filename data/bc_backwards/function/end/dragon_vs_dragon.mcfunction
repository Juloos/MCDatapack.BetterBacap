data modify storage bac_tracker:macro data set value {adv_bac_name:"dragon_vs_dragon",adv_full_name:"blazeandcave:end/dragon_vs_dragon",adv_category:"end",adv_extra_categories:[],adv_bac_type:"goal",player_bac_team:"any",member_adv_rank:-1s}
