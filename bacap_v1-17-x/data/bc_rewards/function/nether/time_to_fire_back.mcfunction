data modify storage bac_tracker:macro data set value {adv_bac_name:"time_to_fire_back",adv_full_name:"blazeandcave:nether/time_to_fire_back",adv_category:"nether",adv_extra_categories:[],adv_bac_type:"goal",player_bac_team:"any",member_adv_rank:-1s}
