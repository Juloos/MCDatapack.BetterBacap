data modify storage bac_tracker:macro data set value {adv_bac_name:"shear_brilliance",adv_full_name:"minecraft:husbandry/remove_wolf_armor",adv_category:"animal",adv_extra_categories:[],adv_bac_type:"task",player_bac_team:"any",member_adv_rank:-1s}
