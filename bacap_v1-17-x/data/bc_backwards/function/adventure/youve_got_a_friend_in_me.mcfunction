data modify storage bac_tracker:macro data set value {adv_bac_name:"youve_got_a_friend_in_me",adv_full_name:"minecraft:husbandry/allay_deliver_item_to_player",adv_category:"adventure",adv_extra_categories:[],adv_bac_type:"task",player_bac_team:"any",member_adv_rank:-1s}
