data modify storage bac_tracker:macro data set value {adv_bac_name:"there_has_to_be_another_way",adv_full_name:"blazeandcave:monsters/there_has_to_be_another_way",adv_category:"monsters",adv_extra_categories:[],adv_bac_type:"task",player_bac_team:"any",member_adv_rank:-1s}
