data modify storage bac_tracker:macro data set value {adv_bac_name:"sound_the_alarm",adv_full_name:"blazeandcave:adventure/sound_the_alarm",adv_category:"adventure",adv_extra_categories:[],adv_bac_type:"task",player_bac_team:"any",member_adv_rank:-1s}
