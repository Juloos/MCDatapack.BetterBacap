data modify storage bac_tracker:macro data set value {adv_bac_name:"om_nom_nom",adv_full_name:"blazeandcave:statistics/om_nom_nom",adv_category:"statistics",adv_extra_categories:[],adv_bac_type:"task",player_bac_team:"any",member_adv_rank:-1s}
