data modify storage bac_tracker:macro data set value {adv_bac_name:"get_a_lode_of_this",adv_full_name:"blazeandcave:nether/get_a_lode_of_this",adv_category:"nether",adv_extra_categories:[],adv_bac_type:"task",player_bac_team:"any",member_adv_rank:-1s}
