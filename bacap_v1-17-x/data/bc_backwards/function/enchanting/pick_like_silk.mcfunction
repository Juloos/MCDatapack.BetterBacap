data modify storage bac_tracker:macro data set value {adv_bac_name:"pick_like_silk",adv_full_name:"blazeandcave:enchanting/pick_like_silk",adv_category:"enchanting",adv_extra_categories:[],adv_bac_type:"challenge",player_bac_team:"any",member_adv_rank:-1s}
