data modify storage bac_tracker:macro data set value {adv_bac_name:"kelp_me",adv_full_name:"blazeandcave:farming/kelp_me",adv_category:"farming",adv_extra_categories:[],adv_bac_type:"task",player_bac_team:"any",member_adv_rank:-1s}
