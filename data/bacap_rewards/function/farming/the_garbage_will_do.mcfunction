data modify storage bac_tracker:macro data set value {adv_bac_name:"the_garbage_will_do",adv_full_name:"blazeandcave:farming/the_garbage_will_do",adv_category:"farming",adv_extra_categories:[],adv_bac_type:"task",player_bac_team:"any",member_adv_rank:-1s}
