data modify storage bac_tracker:macro data set value {adv_bac_name:"what_about_corruption_planks",adv_full_name:"blazeandcave:nether/what_about_corruption_planks",adv_category:"nether",adv_extra_categories:[],adv_bac_type:"goal",player_bac_team:"any",member_adv_rank:-1s}
