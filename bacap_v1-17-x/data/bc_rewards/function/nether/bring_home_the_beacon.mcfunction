data modify storage bac_tracker:macro data set value {adv_bac_name:"bring_home_the_beacon",adv_full_name:"minecraft:nether/create_beacon",adv_category:"nether",adv_extra_categories:[],adv_bac_type:"goal",player_bac_team:"any",member_adv_rank:-1s}
