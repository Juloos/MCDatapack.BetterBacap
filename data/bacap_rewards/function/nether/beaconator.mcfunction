data modify storage bac_tracker:macro data set value {adv_bac_name:"beaconator",adv_full_name:"minecraft:nether/create_full_beacon",adv_category:"nether",adv_extra_categories:["trophy"],adv_bac_type:"challenge",player_bac_team:"any",member_adv_rank:-1s}
