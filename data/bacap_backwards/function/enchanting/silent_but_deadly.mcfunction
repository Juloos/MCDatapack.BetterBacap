data modify storage bac_tracker:macro data set value {adv_bac_name:"silent_but_deadly",adv_full_name:"blazeandcave:enchanting/silent_but_deadly",adv_category:"enchanting",adv_extra_categories:["trophy"],adv_bac_type:"challenge",player_bac_team:"any",member_adv_rank:-1s}
