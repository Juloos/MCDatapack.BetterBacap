data modify storage bac_tracker:macro data set value {adv_bac_name:"terralithic",adv_full_name:"blazeandcave:biomes/terralithic",adv_category:"biomes",adv_extra_categories:["terralith","trophy"],adv_bac_type:"challenge",player_bac_team:"any",member_adv_rank:-1s}
