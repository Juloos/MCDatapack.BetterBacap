data modify storage bac_tracker:macro data set value {adv_bac_name:"some_breakthrough",adv_full_name:"blazeandcave:end/some_breakthrough",adv_category:"end",adv_extra_categories:[],adv_bac_type:"challenge",player_bac_team:"any",member_adv_rank:-1s}
