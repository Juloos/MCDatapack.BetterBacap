data modify storage bac_tracker:macro data set value {adv_bac_name:"elmer_mudd",adv_full_name:"blazeandcave:building/elmer_mudd",adv_category:"building",adv_extra_categories:["trophy"],adv_bac_type:"task",player_bac_team:"any",member_adv_rank:-1s}
