data modify storage bac_tracker:macro data set value {adv_bac_name:"biomes_milestone",adv_full_name:"blazeandcave:bacap/biomes_milestone",adv_category:"bacap",adv_extra_categories:["trophy","milestones"],adv_bac_type:"milestone",player_bac_team:"any",member_adv_rank:-1s}
