data modify storage bac_tracker:macro data set value {adv_bac_name:"sneak_100",adv_full_name:"minecraft:adventure/avoid_vibration",adv_category:"mining",adv_extra_categories:[],adv_bac_type:"task",player_bac_team:"any",member_adv_rank:-1s}
