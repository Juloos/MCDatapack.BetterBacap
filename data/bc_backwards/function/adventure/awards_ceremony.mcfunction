data modify storage bac_tracker:macro data set value {adv_bac_name:"awards_ceremony",adv_full_name:"blazeandcave:adventure/awards_ceremony",adv_category:"adventure",adv_extra_categories:["hidden","trophy"],adv_bac_type:"challenge",player_bac_team:"any",member_adv_rank:-1s}
