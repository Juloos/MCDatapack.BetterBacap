data modify storage bac_tracker:macro data set value {adv_bac_name:"monstrous_sacrifices",adv_full_name:"blazeandcave:redstone/monstrous_sacrifices",adv_category:"redstone",adv_extra_categories:[],adv_bac_type:"challenge",player_bac_team:"any",member_adv_rank:-1s}
