data modify storage bac_tracker:macro data set value {adv_bac_name:"you_need_a_mint",adv_full_name:"minecraft:end/dragon_breath",adv_category:"potion",adv_extra_categories:[],adv_bac_type:"task",player_bac_team:"any",member_adv_rank:-1s}
