data modify storage bac_tracker:macro data set value {adv_bac_name:"super_mooshroom",adv_full_name:"blazeandcave:animal/super_mooshroom",adv_category:"animal",adv_extra_categories:[],adv_bac_type:"task",player_bac_team:"any",member_adv_rank:-1s}
