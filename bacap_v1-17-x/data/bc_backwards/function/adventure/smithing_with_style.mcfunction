data modify storage bac_tracker:macro data set value {adv_bac_name:"smithing_with_style",adv_full_name:"minecraft:adventure/trim_with_all_exclusive_armor_patterns",adv_category:"adventure",adv_extra_categories:["trophy"],adv_bac_type:"challenge",player_bac_team:"any",member_adv_rank:-1s}
