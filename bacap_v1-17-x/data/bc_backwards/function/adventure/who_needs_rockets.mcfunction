data modify storage bac_tracker:macro data set value {adv_bac_name:"who_needs_rockets",adv_full_name:"minecraft:adventure/who_needs_rockets",adv_category:"adventure",adv_extra_categories:[],adv_bac_type:"task",player_bac_team:"any",member_adv_rank:-1s}
