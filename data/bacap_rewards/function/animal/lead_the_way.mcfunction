data modify storage bac_tracker:macro data set value {adv_bac_name:"lead_the_way",adv_full_name:"blazeandcave:animal/lead_the_way",adv_category:"animal",adv_extra_categories:[],adv_bac_type:"task",player_bac_team:"any",member_adv_rank:-1s}
