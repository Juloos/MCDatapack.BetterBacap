data modify storage bac_tracker:macro data set value {adv_bac_name:"lighten_up",adv_full_name:"minecraft:adventure/lighten_up",adv_category:"building",adv_extra_categories:[],adv_bac_type:"task",player_bac_team:"any",member_adv_rank:-1s}
