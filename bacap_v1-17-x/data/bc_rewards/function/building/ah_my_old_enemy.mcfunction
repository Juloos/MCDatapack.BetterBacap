data modify storage bac_tracker:macro data set value {adv_bac_name:"ah_my_old_enemy",adv_full_name:"blazeandcave:building/ah_my_old_enemy",adv_category:"building",adv_extra_categories:["trophy"],adv_bac_type:"goal",player_bac_team:"any",member_adv_rank:-1s}
