data modify storage bac_tracker:macro data set value {adv_bac_name:"the_power_of_books",adv_full_name:"minecraft:adventure/read_power_of_chiseled_bookshelf",adv_category:"redstone",adv_extra_categories:[],adv_bac_type:"task",player_bac_team:"any",member_adv_rank:-1s}
