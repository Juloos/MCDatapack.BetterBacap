data modify storage bac_tracker:macro data set value {adv_bac_name:"a_knight_to_nether_forget",adv_full_name:"minecraft:nether/netherite_armor",adv_category:"nether",adv_extra_categories:[],adv_bac_type:"goal",player_bac_team:"any",member_adv_rank:-1s}
