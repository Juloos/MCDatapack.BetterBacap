data modify storage bac_tracker:macro data set value {adv_bac_name:"rock_paper_shears",adv_full_name:"blazeandcave:weaponry/rock_paper_shears",adv_category:"weaponry",adv_extra_categories:[],adv_bac_type:"task",player_bac_team:"any",member_adv_rank:-1s}
