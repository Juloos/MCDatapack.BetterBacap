data modify storage bac_tracker:macro data set value {adv_bac_name:"what_a_deal",adv_full_name:"minecraft:adventure/trade",adv_category:"adventure",adv_extra_categories:[],adv_bac_type:"task",player_bac_team:"any",member_adv_rank:-1s}
