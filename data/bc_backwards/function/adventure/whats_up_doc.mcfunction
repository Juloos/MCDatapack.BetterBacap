data modify storage bac_tracker:macro data set value {adv_bac_name:"whats_up_doc",adv_full_name:"blazeandcave:adventure/whats_up_doc",adv_category:"adventure",adv_extra_categories:["trophy"],adv_bac_type:"task",player_bac_team:"any",member_adv_rank:-1s}
