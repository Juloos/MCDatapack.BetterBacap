$give @s poppy[item_name='{"translate":"A blessing in love","color":"light_purple","bold":true,"italic":false}',lore=['{"translate":"Face your fears and ask your crush out!","color":"light_purple"}','{"text":" "}','{"translate":"Awarded to %s for achieving","with":[{"text":"$(player_name)","color":"white","italic":false}],"color":"gray"}','{"translate":"For you, my sweet","color":"green","italic":false}'],custom_model_data=131,custom_data={Trophy:1},enchantment_glint_override=true,hide_additional_tooltip={}] 1
