data modify storage bac_tracker:macro data set value {adv_bac_name:"ludicrous_speed",adv_full_name:"blazeandcave:nether/ludicrous_speed",adv_category:"nether",adv_extra_categories:["trophy"],adv_bac_type:"challenge",player_bac_team:"any",member_adv_rank:-1s}
