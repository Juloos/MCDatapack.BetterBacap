data modify storage bac_tracker:macro data set value {adv_bac_name:"particle_fan",adv_full_name:"blazeandcave:mining/particle_fan",adv_category:"mining",adv_extra_categories:[],adv_bac_type:"task",player_bac_team:"any",member_adv_rank:-1s}
