data modify storage bac_tracker:macro data set value {adv_bac_name:"sly_copper_the_copper_heist",adv_full_name:"blazeandcave:mining/sly_copper_the_copper_heist",adv_category:"mining",adv_extra_categories:["trophy"],adv_bac_type:"challenge",player_bac_team:"any",member_adv_rank:-1s}
