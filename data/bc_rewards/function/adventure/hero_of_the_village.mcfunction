data modify storage bac_tracker:macro data set value {adv_bac_name:"hero_of_the_village",adv_full_name:"minecraft:adventure/hero_of_the_village",adv_category:"adventure",adv_extra_categories:[],adv_bac_type:"goal",player_bac_team:"any",member_adv_rank:-1s}
