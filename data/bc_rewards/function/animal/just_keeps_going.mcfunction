data modify storage bac_tracker:macro data set value {adv_bac_name:"just_keeps_going",adv_full_name:"blazeandcave:animal/just_keeps_going",adv_category:"animal",adv_extra_categories:["trophy"],adv_bac_type:"challenge",player_bac_team:"any",member_adv_rank:-1s}
