data modify storage bac_tracker:macro data set value {adv_bac_name:"eye_spy",adv_full_name:"minecraft:story/follow_ender_eye",adv_category:"nether",adv_extra_categories:[],adv_bac_type:"task",player_bac_team:"any",member_adv_rank:-1s}
