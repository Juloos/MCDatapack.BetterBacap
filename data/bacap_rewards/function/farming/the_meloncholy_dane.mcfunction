data modify storage bac_tracker:macro data set value {adv_bac_name:"the_meloncholy_dane",adv_full_name:"blazeandcave:farming/the_meloncholy_dane",adv_category:"farming",adv_extra_categories:[],adv_bac_type:"goal",player_bac_team:"any",member_adv_rank:-1s}
