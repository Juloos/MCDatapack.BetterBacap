data modify storage bac_tracker:macro data set value {adv_bac_name:"marathon",adv_full_name:"blazeandcave:statistics/marathon",adv_category:"statistics",adv_extra_categories:[],adv_bac_type:"goal",player_bac_team:"any",member_adv_rank:-1s}
