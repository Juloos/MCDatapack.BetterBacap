data modify storage bac_tracker:macro data set value {adv_bac_name:"raiders_of_the_lost_trim",adv_full_name:"blazeandcave:adventure/raiders_of_the_lost_trim",adv_category:"adventure",adv_extra_categories:[],adv_bac_type:"goal",player_bac_team:"any",member_adv_rank:-1s}
