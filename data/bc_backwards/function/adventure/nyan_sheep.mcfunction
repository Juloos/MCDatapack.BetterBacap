data modify storage bac_tracker:macro data set value {adv_bac_name:"nyan_sheep",adv_full_name:"blazeandcave:adventure/nyan_sheep",adv_category:"adventure",adv_extra_categories:["trophy"],adv_bac_type:"task",player_bac_team:"any",member_adv_rank:-1s}
