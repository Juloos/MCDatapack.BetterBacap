data modify storage bac_tracker:macro data set value {adv_bac_name:"a_furious_test_subject",adv_full_name:"blazeandcave:potion/a_furious_test_subject",adv_category:"potion",adv_extra_categories:["trophy"],adv_bac_type:"challenge",player_bac_team:"any",member_adv_rank:-1s}
