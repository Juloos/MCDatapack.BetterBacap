data modify storage bac_tracker:macro data set value {adv_bac_name:"billy_the_kid",adv_full_name:"blazeandcave:animal/billy_the_kid",adv_category:"animal",adv_extra_categories:[],adv_bac_type:"task",player_bac_team:"any",member_adv_rank:-1s}
