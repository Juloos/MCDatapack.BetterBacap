data modify storage bac_tracker:macro data set value {adv_bac_name:"leader_of_the_pack",adv_full_name:"minecraft:husbandry/tame_an_animal",adv_category:"animal",adv_extra_categories:[],adv_bac_type:"task",player_bac_team:"any",member_adv_rank:-1s}
