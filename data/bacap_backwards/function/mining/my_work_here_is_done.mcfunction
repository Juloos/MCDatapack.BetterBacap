data modify storage bac_tracker:macro data set value {adv_bac_name:"my_work_here_is_done",adv_full_name:"blazeandcave:mining/my_work_here_is_done",adv_category:"mining",adv_extra_categories:[],adv_bac_type:"task",player_bac_team:"any",member_adv_rank:-1s}
