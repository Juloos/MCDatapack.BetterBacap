data modify storage bac_tracker:macro data set value {adv_bac_name:"edge_of_the_jungle",adv_full_name:"blazeandcave:biomes/edge_of_the_jungle",adv_category:"biomes",adv_extra_categories:["hidden","trophy"],adv_bac_type:"challenge",player_bac_team:"any",member_adv_rank:-1s}
