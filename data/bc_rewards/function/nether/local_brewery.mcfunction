data modify storage bac_tracker:macro data set value {adv_bac_name:"local_brewery",adv_full_name:"minecraft:nether/brew_potion",adv_category:"nether",adv_extra_categories:[],adv_bac_type:"task",player_bac_team:"any",member_adv_rank:-1s}
