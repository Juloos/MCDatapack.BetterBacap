data modify storage bac_tracker:macro data set value {adv_bac_name:"eruption_in_the_air",adv_full_name:"blazeandcave:biomes/eruption_in_the_air",adv_category:"biomes",adv_extra_categories:["terralith"],adv_bac_type:"goal",player_bac_team:"any",member_adv_rank:-1s}
