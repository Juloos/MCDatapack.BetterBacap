data modify storage bac_tracker:macro data set value {adv_bac_name:"its_high_noon",adv_full_name:"blazeandcave:animal/its_high_noon",adv_category:"animal",adv_extra_categories:[],adv_bac_type:"challenge",player_bac_team:"any",member_adv_rank:-1s}
