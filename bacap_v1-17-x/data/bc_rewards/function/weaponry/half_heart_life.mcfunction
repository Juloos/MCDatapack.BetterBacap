data modify storage bac_tracker:macro data set value {adv_bac_name:"half_heart_life",adv_full_name:"blazeandcave:weaponry/half_heart_life",adv_category:"weaponry",adv_extra_categories:[],adv_bac_type:"goal",player_bac_team:"any",member_adv_rank:-1s}
