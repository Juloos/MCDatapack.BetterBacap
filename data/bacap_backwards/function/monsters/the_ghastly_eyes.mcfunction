data modify storage bac_tracker:macro data set value {adv_bac_name:"the_ghastly_eyes",adv_full_name:"blazeandcave:monsters/the_ghastly_eyes",adv_category:"monsters",adv_extra_categories:[],adv_bac_type:"challenge",player_bac_team:"any",member_adv_rank:-1s}
