data modify storage bac_tracker:macro data set value {adv_bac_name:"that_is_so_fletch",adv_full_name:"blazeandcave:weaponry/that_is_so_fletch",adv_category:"weaponry",adv_extra_categories:[],adv_bac_type:"task",player_bac_team:"any",member_adv_rank:-1s}
