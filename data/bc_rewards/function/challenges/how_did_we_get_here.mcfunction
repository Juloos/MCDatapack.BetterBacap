data modify storage bac_tracker:macro data set value {adv_bac_name:"how_did_we_get_here",adv_full_name:"minecraft:nether/all_effects",adv_category:"challenges",adv_extra_categories:["trophy"],adv_bac_type:"challenge",player_bac_team:"any",member_adv_rank:-1s}
