data modify storage bac_tracker:macro data set value {adv_bac_name:"burnt_right_into_your_soul",adv_full_name:"blazeandcave:nether/burnt_right_into_your_soul",adv_category:"nether",adv_extra_categories:[],adv_bac_type:"task",player_bac_team:"any",member_adv_rank:-1s}
