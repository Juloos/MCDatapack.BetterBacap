data modify storage bac_tracker:macro data set value {adv_bac_name:"the_tribal_villagers",adv_full_name:"blazeandcave:adventure/the_tribal_villagers",adv_category:"adventure",adv_extra_categories:[],adv_bac_type:"goal",player_bac_team:"any",member_adv_rank:-1s}
