data modify storage bac_tracker:macro data set value {adv_bac_name:"art_gallery",adv_full_name:"blazeandcave:building/art_gallery",adv_category:"building",adv_extra_categories:[],adv_bac_type:"goal",player_bac_team:"any",member_adv_rank:-1s}
