data modify storage bac_tracker:macro data set value {adv_bac_name:"skys_the_limit",adv_full_name:"minecraft:end/elytra",adv_category:"end",adv_extra_categories:[],adv_bac_type:"goal",player_bac_team:"any",member_adv_rank:-1s}
