data modify storage bac_tracker:macro data set value {adv_bac_name:"the_whole_pack",adv_full_name:"minecraft:husbandry/whole_pack",adv_category:"animal",adv_extra_categories:["trophy"],adv_bac_type:"challenge",player_bac_team:"any",member_adv_rank:-1s}
