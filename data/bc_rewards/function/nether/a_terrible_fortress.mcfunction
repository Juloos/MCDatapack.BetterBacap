data modify storage bac_tracker:macro data set value {adv_bac_name:"a_terrible_fortress",adv_full_name:"minecraft:nether/find_fortress",adv_category:"nether",adv_extra_categories:[],adv_bac_type:"task",player_bac_team:"any",member_adv_rank:-1s}
