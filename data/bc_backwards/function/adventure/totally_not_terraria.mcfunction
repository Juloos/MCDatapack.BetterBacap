data modify storage bac_tracker:macro data set value {adv_bac_name:"totally_not_terraria",adv_full_name:"blazeandcave:adventure/totally_not_terraria",adv_category:"adventure",adv_extra_categories:["terralith"],adv_bac_type:"task",player_bac_team:"any",member_adv_rank:-1s}
