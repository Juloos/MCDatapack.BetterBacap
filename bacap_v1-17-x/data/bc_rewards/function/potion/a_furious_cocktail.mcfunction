data modify storage bac_tracker:macro data set value {adv_bac_name:"a_furious_cocktail",adv_full_name:"minecraft:nether/all_potions",adv_category:"potion",adv_extra_categories:[],adv_bac_type:"challenge",player_bac_team:"any",member_adv_rank:-1s}
