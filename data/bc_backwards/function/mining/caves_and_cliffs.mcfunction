data modify storage bac_tracker:macro data set value {adv_bac_name:"caves_and_cliffs",adv_full_name:"minecraft:adventure/fall_from_world_height",adv_category:"mining",adv_extra_categories:["trophy"],adv_bac_type:"challenge",player_bac_team:"any",member_adv_rank:-1s}
