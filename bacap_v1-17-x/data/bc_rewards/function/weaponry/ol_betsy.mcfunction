data modify storage bac_tracker:macro data set value {adv_bac_name:"ol_betsy",adv_full_name:"minecraft:adventure/ol_betsy",adv_category:"weaponry",adv_extra_categories:[],adv_bac_type:"task",player_bac_team:"any",member_adv_rank:-1s}
